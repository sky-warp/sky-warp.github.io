...
Относительно `DI` (Dependency Injection) все понятно - это принцип, который снимает ответственность за внедрение и разрешение зависимостей с самого объекта и делегирует ее DI-системе.
